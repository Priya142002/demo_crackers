        ...
        <div style={styles.summaryGrid}>
          <div style={styles.summaryCard}>
            <div style={styles.summaryContent}>
              ...
              <p style={styles.summaryChange}>₹{dashboardData.totalOrderAmount.toFixed(2)}</p>
          ...
          <div style={styles.summaryCard}>
            <div style={styles.summaryContent}>
              ...
              <p style={styles.summaryChange}>₹{dashboardData.paidButNotDispatched.amount.toFixed(2)}</p>
          ...
          <div style={styles.summaryCard}>
            <div style={styles.summaryContent}>
              ...
              <p style={styles.summaryChange}>₹{dashboardData.dispatchedOrders.amount.toFixed(2)}</p>
...
<div style={styles.bottomSectionItem}>
  <h2 style={styles.sectionTitle}><FaFire style={{ ...styles.sectionIcon, color: "#FF5722" }} /> 
    ...
    {pendingDispatchOrders.map((order, index) => (
      <div key={index} style={styles.topSellingItem}>
        <div style={styles.topSellingRank}>
          #{index + 1} {/* Always show numbered ranking */}
        </div>
              ...
              {recentOrders.map(order => (
                <div key={order.id} style={styles.orderItem}>
                  ...
                  <div style={{ textAlign: "right" }}>
                    <div style={{ fontWeight: "600", fontSize: "14px" }}>₹{order.amount.toFixed(2)}</div>
                    <div style={{
                      fontSize: "12px",
